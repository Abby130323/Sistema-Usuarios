...
public class Estudiante extends SistemasUsuarios{
    ...
    public String grupo;
    public String subir_trabajos;
    
    public Estudiante(String horario_clases, String grupo, String subir_trabajos, String usuario, int id, String password){
    ...
    public void setHorario_clases(String horario_clases){this.horario_clases = this.horario_clases;}
